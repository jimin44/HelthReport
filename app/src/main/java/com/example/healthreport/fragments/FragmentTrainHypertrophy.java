...
public class FragmentTrainHypertrophy extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myView = inflater.inflate(R.layout.fragment_train_hypertrophy, container, false);
        ...
        squat = myView.findViewById(R.id.textView_hyper_squat);
        bench = myView.findViewById(R.id.textView_hyper_bench);
        dead = myView.findViewById(R.id.textView_hyper_dead);
        crunch = myView.findViewById(R.id.textView_hyper_crunch);
        seatedCable = myView.findViewById(R.id.textView_hyper_seated_cable);
        cablePushDown = myView.findViewById(R.id.textView_hyper_cable_pushdown);
        lat = myView.findViewById(R.id.textView_hyper_lat);
        overHead = myView.findViewById(R.id.textView_hyper_overhead_press);
        bicepsCurl = myView.findViewById(R.id.textView_hyper_biceps_curl);
        title = myView.findViewById(R.id.textView10);

        squatO = myView.findViewById(R.id.button_hyper_squat_o);
        benchO = myView.findViewById(R.id.button_hyper_bench_o);
        deadO = myView.findViewById(R.id.button_hyper_dead_o);
        crunchO = myView.findViewById(R.id.button_hyper_crunch_o);
        seatedCableO = myView.findViewById(R.id.button_hyper_seated_cable_o);
        cablePushDownO = myView.findViewById(R.id.button_hyper_cable_pushdown_o);
        latO = myView.findViewById(R.id.button_hyper_lat_o);
        overHeadO = myView.findViewById(R.id.button_hyper_overdead_press_o);
        bicepsCurlO = myView.findViewById(R.id.button_hyper_biceps_curl_o);

        squatX = myView.findViewById(R.id.button_hyper_squat_x);
        benchX = myView.findViewById(R.id.button_hyper_bench_x);
        deadX = myView.findViewById(R.id.button_hyper_dead_x);
        crunchX = myView.findViewById(R.id.button_hyper_crunch_x);
        seatedCableX = myView.findViewById(R.id.button_hyper_seated_cable_x);
        cablePushDownX = myView.findViewById(R.id.button_hyper_cable_pushdown_x);
        latX = myView.findViewById(R.id.button_hyper_lat_x);
        overHeadX = myView.findViewById(R.id.button_hyper_overhead_press_x);
        bicepsCurlX = myView.findViewById(R.id.button_hyper_biceps_curl_x);

        change = myView.findViewById(R.id.button_hyper_change);
        ok = myView.findViewById(R.id.button_hyper_ok);
        ...
        //어제 운동한 기록이 있다면, 완료 화면 띄움(근비대는 2일에 1번 운동하기 때문)
        ...
        databaseReference.child("hypertrophy").addValueEventListener(new ValueEventListener() {
            @Override
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(cntO+cntX==itemCount){
                    databaseReference.child("hypertrophy").get()
                            .addOnSuccessListener(new OnSuccessListener<DataSnapshot>() {
                                ...
                                public void onSuccess(DataSnapshot dataSnapshot) {
                                    for(int i = 0; i<successItem.size(); i++){
                                        ...
                                        String mon = getTime().substring(5,7);
                                        String day = getTime().substring(8,10);
                                        databaseReference.child("hypertrophy").child(successItem.get(i)).child("success").setValue(success + 1);
                                        databaseReference.child(year).child(mon).child(day).child("hypertrophy").child(successItem.get(i)).child("weight").setValue(weight+2.5*success);
                                        databaseReference.child(year).child(mon).child(day).child("hypertrophy").child(successItem.get(i)).child("repeat").setValue(repeat);
                                        databaseReference.child(year).child(mon).child(day).child("hypertrophy").child(successItem.get(i)).child("set").setValue(set);
                                    }
...
//                                        int set = Double.parseDouble(dataSnapshot.child(failItem.get(i)).child("set").getValue().toString());
                                        ...
                                        databaseReference.child(year).child(mon).child(day).child("hypertrophy").child(failItem.get(i)).child("weight").setValue(0);
                                        databaseReference.child(year).child(mon).child(day).child("hypertrophy").child(failItem.get(i)).child("repeat").setValue(0);
                                        databaseReference.child(year).child(mon).child(day).child("hypertrophy").child(failItem.get(i)).child("set").setValue(0);
                                    }
